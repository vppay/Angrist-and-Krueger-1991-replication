...
esttab, se label keep(EDUC RACE SMSA MARRIED AGEQ AGEQSQ) order(EDUC RACE SMSA MARRIED AGEQ AGEQSQ) title("Table VI OLS and TSLS estimates of the return to education for men born 1940 - 1949: 1980 census") nonumbers mtitles("(1) OLS" "(2) TSLS" "(3) OLS" "(4) TSLS" "(5) OLS" "(6) TSLS" "(7) OLS" "(8) TSLS") stats(yob region overid_chi2 overid_df, labels("9 Year-of-birth dummies" "8 Region of residence dummies" "χ2" "dof"))

////Export Table 6
esttab using "C:\Tugas Semester 5\Mikroekonometrika\PS 7\Replication\Tables\Table VI.rtf", se label keep(EDUC RACE SMSA MARRIED AGEQ AGEQSQ) order(EDUC RACE SMSA MARRIED AGEQ AGEQSQ) title("Table VI OLS and TSLS Estimates of The Return to Education for Men Born 1940 - 1949: 1980 Census") nonumbers mtitles("(1) OLS" "(2) TSLS" "(3) OLS" "(4) TSLS" "(5) OLS" "(6) TSLS" "(7) OLS" "(8) TSLS") stats(yob region overid_chi2 overid_df, labels("9 Year-of-birth dummies" "8 Region of residence dummies" "χ2" "dof"))
