...
ivregress 2sls LWKLYWGE YR0-YR8 RACE MARRIED SMSA NEWENG MIDATL ENOCENT WNOCENT SOATL ESOCENT WSOCENT MT AGEQ AGEQSQ (EDUC = QTR1YR0-QTR1YR9 QTR2YR0-QTR2YR9 QTR3YR0-QTR3YR9 YR0-YR8), first
estadd local yob "Yes"
estadd local region "Yes"
eststo model8
estat overid
...
esttab, se label keep(EDUC RACE SMSA MARRIED AGEQ AGEQSQ) order(EDUC RACE SMSA MARRIED AGEQ AGEQSQ) title("Table IV OLS and TSLS estimates of the return to education for men born 1920 - 1929: 1970 census") nonumbers mtitles("(1) OLS" "(2) TSLS" "(3) OLS" "(4) TSLS" "(5) OLS" "(6) TSLS" "(7) OLS" "(8) TSLS") stats(yob region overid_chi2 overid_df, labels("9 Year-of-birth dummies" "8 Region of residence dummies" "χ2" "dof")) 

////Export Table 4
esttab using "C:\Tugas Semester 5\Mikroekonometrika\PS 7\Replication\Tables\Table IV.rtf", se label keep(EDUC RACE SMSA MARRIED AGEQ AGEQSQ) order(EDUC RACE SMSA MARRIED AGEQ AGEQSQ) title("Table IV OLS and TSLS Estimates of The Return to Education for Men Born 1920 - 1929: 1970 Census") nonumbers mtitles("(1) OLS" "(2) TSLS" "(3) OLS" "(4) TSLS" "(5) OLS" "(6) TSLS" "(7) OLS" "(8) TSLS") stats(yob region overid_chi2 overid_df, labels("9 Year-of-birth dummies" "8 Region of residence dummies" "χ2" "dof"))
